...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("http://www.daddyleagues.com/sebl/schedules/strength");
    this.res.end();
  }
    ...
    this.res.writeHead(200);
    postMessage("http://www.daddyleagues.com/sebl/schedules");
    this.res.end();
  }
